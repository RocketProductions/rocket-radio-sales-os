...
export function LeadForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (metaPixelId && typeof window !== "undefined" && (window as unknown as Record<string, unknown>).fbq) {
  ...
  function openShare(platform: "facebook" | "twitter" | "linkedin" | "whatsapp") {
    ...
    window.open(links[platform], "_blank", "width=600,height=500,noopener");
  }
  ...
  if (success) {
    return (
      <div className="flex flex-col items-center text-center space-y-6 py-4">
        ...
        <div className="w-full rounded-xl border border-slate-100 bg-slate-50 p-5 space-y-4">
          <div>
            <p className="text-sm font-semibold text-slate-700">Know someone who could use this?</p>
            <p className="text-xs text-slate-500 mt-0.5">Share this page and help a friend out.</p>
          </div>

          <p className="text-xs italic text-slate-500 bg-white border border-slate-200 rounded-lg px-3 py-2 text-left leading-relaxed">
